...
<div class="col-md-12">
    ...
    <div class="form-group">
		<label for="bbcode">Direct Path</label>
		<div class="input-group">
		    <input id="direct-path" type="text" class="form-control" value="{{ asset(preg_replace('/\/{2,}/', '/', Storage::url($file->path))) }}">
		    <div class="input-group-btn">
		        <button data-clipboard-target="#direct-path" class="btn btn-default" type="submit">
	...
	<div class="form-group">
		<label for="bbcode">Direct Link</label>
		<div class="input-group">
		    <input id="direct-link" type="text" class="form-control" value="{{ $file->download }}">
		    <div class="input-group-btn">
		        <button data-clipboard-target="#direct-link" class="btn btn-default" type="submit">
		        	<i class="fa fa-fw fa-copy"></i>
		        </button>
		    </div>
		</div>
	...
	<div class="form-group">
		<label for="bbcode">Markdown</label>
		<div class="input-group">
		    <input id="markdown" type="text" class="form-control" value="[Download {{ $file->label }}]({{ $file->download }})">
		    <div class="input-group-btn">
		        <button data-clipboard-target="#markdown" class="btn btn-default" type="submit">
		        	<i class="fa fa-fw fa-copy"></i>
		        </button>
		    </div>
		</div>
	...
	<div class="form-group">
		...
		<div class="input-group">
		    <input id="bbcode" type="text" class="form-control" value="[url={{ $file->download }}]Download {{ $file->label }}[/url]">
		    <div class="input-group-btn">
		        <button data-clipboard-target="#bbcode" class="btn btn-default" type="submit">
		        	<i class="fa fa-fw fa-copy"></i>
		        </button>
		    </div>
		</div>
